package vn.edu.usth.pj.MainActivity.Fragment.Explore;
...
import vn.edu.usth.pj.MainActivity.Fragment.Explore.Adapter.News_Adapter;
import vn.edu.usth.pj.MainActivity.Fragment.Explore.Adapter.TopRead_Adapter;
...
import vn.edu.usth.pj.RestAPI.REST_BASE;
import vn.edu.usth.pj.RestAPI.Service2;
...
public class Explore extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<Example> call = restapi.getExplore("2021", "11", "13");
                ...
                if (response.isSuccessful()){
                    ...
                    cardView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent i = new Intent(getContext(), Article.class);
